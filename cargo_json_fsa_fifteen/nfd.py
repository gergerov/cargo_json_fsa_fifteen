...
movement_detail = (
    pars.Group(
        b.day('day_of_notification') +
        b.month('month_notification') +
        b.time('actual_time_of_givan_status_event') +
        b.slant_separator +
        b.airport_code('airport_code_of_notification')
    )
)('movement_detail')
...
status_detail_nfd = (
    pars.Group(
        pars.Literal('NFD')('status_code') +
        b.slant_separator +
        movement_detail +
        quantity_detail +
        pars.Optional(notification_to_detail) +
        b.crlf_separator +
        pars.Optional(oci)
    )
)('status_detail')